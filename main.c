...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        if (ret != 0) {
            ...
            if (pad_data & PAD_LEFT)      scr_printf("LEFT ");
            if (pad_data & PAD_RIGHT)     scr_printf("RIGHT ");
            if (pad_data & PAD_UP)        scr_printf("UP ");
            if (pad_data & PAD_DOWN)      scr_printf("DOWN ");
            if (pad_data & PAD_CROSS)     scr_printf("X ");
            if (pad_data & PAD_CIRCLE)    scr_printf("O ");
            if (pad_data & PAD_SQUARE)    scr_printf("[] ");
            if (pad_data & PAD_TRIANGLE)  scr_printf("/\\ ");
            if (pad_data & PAD_L1)        scr_printf("L1 ");
            if (pad_data & PAD_L2)        scr_printf("L2 ");
            if (pad_data & PAD_R1)        scr_printf("R1 ");
            if (pad_data & PAD_R2)        scr_printf("R2 ");
            if (pad_data & PAD_START)     scr_printf("START ");
            if (pad_data & PAD_SELECT)    scr_printf("SELECT ");
